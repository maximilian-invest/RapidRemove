/* Route: /it/eliminare-profilo-attivita-google — localized "Delete Google Business Profile" hub article
   (data-driven MagArticle; the German flagship lives at /magazin/...). */
import MagArticle from "@/components/MagArticle";
import data from "@/lib/articles/it-hub-eliminare-profilo-attivita-google";
