/* Route: /it/verifica-profilo — lokalisierte Wizard-Einstiegs-URL (öffnet den Lösch-Check). */
...
export default function Page() {
  return <App initialLang="it" initialView="wizard" magCards={magCardsFor("it")} />;
}
