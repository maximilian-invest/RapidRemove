/* Route: /pt/verificar-perfil — lokalisierte Wizard-Einstiegs-URL (öffnet den Lösch-Check). */
...
export default function Page() {
  return <App initialLang="pt" initialView="wizard" magCards={magCardsFor("pt")} />;
}
