/* Route: /sv/kontrollera-profil — lokalisierte Wizard-Einstiegs-URL (öffnet den Lösch-Check). */
...
export default function Page() {
  return <App initialLang="sv" initialView="wizard" magCards={magCardsFor("sv")} />;
}
