/* Route: /no/slett-google-bedriftsprofil — localized "Delete Google Business Profile" hub article
   (data-driven MagArticle; the German flagship lives at /magazin/...). */
import MagArticle from "@/components/MagArticle";
import data from "@/lib/articles/no-hub-slett-google-bedriftsprofil";
