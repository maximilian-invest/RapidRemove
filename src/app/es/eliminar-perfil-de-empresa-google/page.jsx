/* Route: /es/eliminar-perfil-de-empresa-google — localized "Delete Google Business Profile" hub article
   (data-driven MagArticle; the German flagship lives at /magazin/...). */
import MagArticle from "@/components/MagArticle";
import data from "@/lib/articles/es-hub-eliminar-perfil-de-empresa-google";
