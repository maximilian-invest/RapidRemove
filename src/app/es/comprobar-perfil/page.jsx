/* Route: /es/comprobar-perfil — lokalisierte Wizard-Einstiegs-URL (öffnet den Lösch-Check). */
...
export default function Page() {
  return <App initialLang="es" initialView="wizard" magCards={magCardsFor("es")} />;
}
