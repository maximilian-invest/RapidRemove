...
const KONTAKT_COPY = {
  de: {
    ...
    lead: "Ob eine Frage zur Löschung, ein laufender Auftrag oder eine Partnerschaft – wir antworten persönlich, in der Regel innerhalb von 24 Stunden.",
    ...
    sentH: "Vielen Dank! Ihre Nachricht ist bei uns.", sentP: "Wir melden uns in der Regel innerhalb von 24 Stunden – an Werktagen oft schneller.", sentBtn: "Weitere Nachricht senden",
  ...
  en: {
    ...
    lead: "A question about removal, an ongoing case or a partnership – we reply personally, usually within 24 hours.",
    ...
    sentH: "Thank you! We've received your message.", sentP: "We usually reply within 24 hours – often faster on business days.", sentBtn: "Send another message",
  ...
  es: {
    ...
    lead: "Una duda sobre la eliminación, un encargo en curso o una colaboración: respondemos en persona, normalmente en menos de 24 horas.",
    ...
    sentH: "¡Gracias! Hemos recibido su mensaje.", sentP: "Normalmente respondemos en menos de 24 horas, a menudo más rápido en días laborables.", sentBtn: "Enviar otro mensaje",
  ...
  fr: {
    ...
    lead: "Une question sur la suppression, un dossier en cours ou un partenariat : nous répondons personnellement, généralement sous 24 heures.",
    ...
    sentH: "Merci ! Nous avons bien reçu votre message.", sentP: "Nous répondons généralement sous 24 heures, souvent plus vite en jours ouvrés.", sentBtn: "Envoyer un autre message",
  ...
  it: {
    ...
    lead: "Una domanda sulla rimozione, un incarico in corso o una collaborazione: rispondiamo personalmente, di solito entro 24 ore.",
    ...
    sentH: "Grazie! Abbiamo ricevuto il suo messaggio.", sentP: "Di solito rispondiamo entro 24 ore, spesso più rapidamente nei giorni feriali.", sentBtn: "Invia un altro messaggio",
  ...
  nl: {
    ...
    lead: "Een vraag over verwijdering, een lopende opdracht of een partnerschap – we reageren persoonlijk, meestal binnen 24 uur.",
    ...
    sentH: "Bedankt! We hebben uw bericht ontvangen.", sentP: "We reageren meestal binnen 24 uur – op werkdagen vaak sneller.", sentBtn: "Nog een bericht sturen",
  ...
  pt: {
    ...
    lead: "Uma dúvida sobre a remoção, um pedido em curso ou uma parceria – respondemos pessoalmente, normalmente em menos de 24 horas.",
    ...
    sentH: "Obrigado! Recebemos a sua mensagem.", sentP: "Normalmente respondemos em menos de 24 horas – muitas vezes mais rápido em dias úteis.", sentBtn: "Enviar outra mensagem",
  ...
  ja: {
    ...
    lead: "削除に関するご質問、進行中の案件、提携のご相談など、通常は24時間以内に担当者が直接ご返信します。",
    ...
    topics: ["Googleプロフィールの削除", "口コミ・評判", "進行中の案件について", "パートナーになる", "その他"],
    privacy: "GDPR準拠・秘密厳守。ご記入内容はお問い合わせ対応のみに使用します。",
    send: "メッセージを送る", sending: "送信中 …",
    sentH: "ありがとうございます。メッセージを受け取りました。", sentP: "通常は24時間以内に、営業日ならより早くご返信します。", sentBtn: "別のメッセージを送る",
  ...
  sv: {
    ...
    lead: "En fråga om borttagning, ett pågående ärende eller ett samarbete – vi svarar personligen, oftast inom 24 timmar.",
    ...
    sentH: "Tack! Vi har fått ditt meddelande.", sentP: "Vi svarar oftast inom 24 timmar – ofta snabbare på vardagar.", sentBtn: "Skicka ett till meddelande",
  ...
  da: {
    ...
    lead: "Et spørgsmål om fjernelse, en igangværende sag eller et partnerskab – vi svarer personligt, normalt inden for 24 timer.",
    ...
    sentH: "Tak! Vi har modtaget din besked.", sentP: "Vi svarer normalt inden for 24 timer – ofte hurtigere på hverdage.", sentBtn: "Send en ny besked",
  ...
  no: {
    ...
    lead: "Et spørsmål om fjerning, en pågående sak eller et samarbeid – vi svarer personlig, vanligvis innen 24 timer.",
    ...
    sentH: "Takk! Vi har mottatt meldingen din.", sentP: "Vi svarer vanligvis innen 24 timer – ofte raskere på virkedager.", sentBtn: "Send en ny melding",
