...
/* RapidRemove — eigene Rechtsseiten: Impressum + Datenschutzerklärung.
   ...
   die Sprache folgt der Route bzw. Website-Sprache. Alle Pflichtangaben (Telefon,
   Vertretungsberechtigte, Firmenbuch, Kammer, Behörde) liegen real in COMPANY. */
...
const L = {
  de: {
    ...
    imp: {
      ...
      rep: "Vertretungsberechtigt", repTxt: "Matthias Lang, Maximilian Hölzl (geschäftsführende Gesellschafter)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Zahlungsabwicklung (Stripe, PayPal, Klarna)", "Zahlungen werden über Stripe (Stripe Payments Europe, Ltd., Irland) abgewickelt. Dabei werden die für die Zahlung erforderlichen Daten an Stripe übermittelt. Je nach gewählter Zahlungsart (z. B. Kreditkarte, PayPal, Klarna, iDEAL) erfolgt die Abwicklung über weitere Zahlungsdienstleister wie PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxemburg) oder Klarna Bank AB (Schweden); ergänzend gelten deren Datenschutzhinweise. Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO. Details: stripe.com/privacy."],
        ...
        ["Analyse, Marketing & Affiliate-Tracking (Google Tag Manager, FirstPromoter)", "Nur mit Ihrer Einwilligung über unseren Cookie-Hinweis laden wir den Google Tag Manager (Google Ireland Ltd., Irland), über den Analyse- und Marketing-Tags (z. B. Conversion-Messung) ausgespielt werden, sowie FirstPromoter zur Zuordnung von Partner-Empfehlungen. Dabei können Cookies gesetzt und Daten (z. B. IP-Adresse, Geräte- und Nutzungsdaten) verarbeitet und ggf. in Drittländer (insbesondere USA) übermittelt werden. Rechtsgrundlage: Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Ohne Einwilligung werden diese Dienste nicht geladen; Sie können Ihre Entscheidung jederzeit über „Cookie-Einstellungen“ im Footer ändern."],
        ["Meta-Pixel (Facebook, Instagram)", "Nur mit Ihrer Einwilligung über unseren Cookie-Hinweis laden wir das Meta-Pixel von Meta Platforms Ireland Ltd. (Irland). Damit messen wir den Erfolg unserer Werbeanzeigen auf Facebook und Instagram (z. B. abgeschickter Gratis-Check, erteilter Auftrag) und bilden Zielgruppen für Werbung. Dabei können Cookies gesetzt und Daten (z. B. IP-Adresse, Geräte- und Nutzungsdaten, aufgerufene Seiten, ausgelöste Ereignisse) verarbeitet und in die USA übermittelt werden. Über das Browser-Pixel übermitteln wir keine Angaben, die Sie identifizieren; „Advanced Matching“ ist deaktiviert. Zusätzlich melden wir – ebenfalls nur mit Ihrer Einwilligung – Ereignisse serverseitig über die Conversions API von Meta, damit ein Abschluss der Anzeige zugeordnet werden kann. Dabei werden Ihre E-Mail-Adresse und Ihre Telefonnummer ausschließlich als nicht umkehrbarer Hashwert (SHA-256) übertragen, niemals im Klartext; zusätzlich werden IP-Adresse, Browserkennung und die Klick-Kennung der Anzeige übermittelt. Den von Ihnen eingegebenen Firmennamen und das geprüfte Google-Profil übermitteln wir in keinem Fall. Ohne Einwilligung unterbleibt auch diese serverseitige Übermittlung vollständig. Rechtsgrundlage: Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Ohne Einwilligung wird das Pixel nicht geladen; Sie können Ihre Entscheidung jederzeit über „Cookie-Einstellungen“ im Footer ändern. Details: facebook.com/privacy/policy."],
        ["Bewertungen (Trustpilot)", "Wir zeigen unsere aktuelle Trustpilot-Bewertung an und verlinken auf unser Profil bei Trustpilot (Trustpilot A/S, Dänemark). Beim bloßen Besuch unserer Website werden keine Daten an Trustpilot übermittelt; erst wenn Sie dem Link folgen, gilt die Datenschutzerklärung von Trustpilot."],
  ...
  en: {
    ...
    imp: {
      ...
      rep: "Authorised representatives", repTxt: "Matthias Lang, Maximilian Hölzl (managing partners)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Payments (Stripe, PayPal, Klarna)", "Payments are processed via Stripe (Stripe Payments Europe, Ltd., Ireland). The data required for the payment is transmitted to Stripe. Depending on the chosen payment method (e.g. credit card, PayPal, Klarna, iDEAL), processing may involve further payment providers such as PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxembourg) or Klarna Bank AB (Sweden); their privacy notices additionally apply. Legal basis: Art. 6(1)(b) GDPR. Details: stripe.com/privacy."],
        ...
        ["Analytics, marketing & affiliate tracking (Google Tag Manager, FirstPromoter)", "Only with your consent via our cookie notice do we load Google Tag Manager (Google Ireland Ltd., Ireland), which delivers analytics and marketing tags (e.g. conversion measurement), and FirstPromoter to attribute partner referrals. Cookies may be set and data (e.g. IP address, device and usage data) processed and possibly transferred to third countries (in particular the USA). Legal basis: consent (Art. 6(1)(a) GDPR). Without consent these services are not loaded; you can change your decision at any time via “Cookie settings” in the footer."],
        ["Meta Pixel (Facebook, Instagram)", "Only with your consent via our cookie notice do we load the Meta Pixel from Meta Platforms Ireland Ltd. (Ireland). We use it to measure the performance of our ads on Facebook and Instagram (e.g. free check submitted, order placed) and to build advertising audiences. Cookies may be set and data (e.g. IP address, device and usage data, pages viewed, events triggered) processed and transferred to the USA. Via the browser pixel we transmit no information that identifies you; “Advanced Matching” is disabled. In addition — again only with your consent — we report events server-side via Meta's Conversions API so that a completed order can be attributed to the ad. Your email address and phone number are transmitted solely as an irreversible hash (SHA-256), never in clear text; IP address, browser identifier and the ad's click identifier are also transmitted. The company name you entered and the Google profile you checked are never transmitted. Without consent this server-side transmission does not take place either. Legal basis: consent (Art. 6(1)(a) GDPR). Without consent the pixel is not loaded; you can change your decision at any time via “Cookie settings” in the footer. Details: facebook.com/privacy/policy."],
        ["Reviews (Trustpilot)", "We display our current Trustpilot rating and link to our profile on Trustpilot (Trustpilot A/S, Denmark). No data is transmitted to Trustpilot when you merely visit our website; only when you follow the link does Trustpilot's privacy policy apply."],
  ...
  es: {
    ...
    imp: {
      ...
      rep: "Representantes autorizados", repTxt: "Matthias Lang, Maximilian Hölzl (socios gerentes)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Pagos (Stripe, PayPal, Klarna)", "Los pagos se procesan a través de Stripe (Stripe Payments Europe, Ltd., Irlanda). Los datos necesarios para el pago se transmiten a Stripe. Según la forma de pago elegida (p. ej., tarjeta de crédito, PayPal, Klarna, iDEAL), la tramitación puede realizarse a través de otros proveedores de pago como PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxemburgo) o Klarna Bank AB (Suecia); se aplican además sus avisos de privacidad. Base jurídica: art. 6, apdo. 1, letra b del RGPD. Más información: stripe.com/privacy."],
        ...
        ["Análisis, marketing y seguimiento de afiliados (Google Tag Manager, FirstPromoter)", "Solo con su consentimiento, a través de nuestro aviso de cookies, cargamos Google Tag Manager (Google Ireland Ltd., Irlanda), mediante el cual se ejecutan etiquetas de análisis y marketing (p. ej., medición de conversiones), así como FirstPromoter para atribuir recomendaciones de socios. Pueden instalarse cookies y tratarse datos (p. ej., dirección IP, datos del dispositivo y de uso), con posible transferencia a terceros países (en particular, EE. UU.). Base jurídica: consentimiento (art. 6, apdo. 1, letra a del RGPD). Sin consentimiento, estos servicios no se cargan; puede cambiar su decisión en cualquier momento en «Configuración de cookies», en el pie de página."],
        ["Píxel de Meta (Facebook, Instagram)", "Solo con su consentimiento, a través de nuestro aviso de cookies, cargamos el píxel de Meta de Meta Platforms Ireland Ltd. (Irlanda). Lo utilizamos para medir el rendimiento de nuestros anuncios en Facebook e Instagram (p. ej., análisis gratuito enviado, pedido realizado) y para crear públicos publicitarios. Pueden instalarse cookies y tratarse datos (p. ej., dirección IP, datos del dispositivo y de uso, páginas visitadas, eventos activados), con transferencia a EE. UU. A través del píxel del navegador no transmitimos ningún dato que le identifique; la «concordancia avanzada» (Advanced Matching) está desactivada. Además, y también solo con su consentimiento, comunicamos eventos del lado del servidor mediante la Conversions API de Meta, para poder atribuir un pedido al anuncio. Su correo electrónico y su teléfono se transmiten exclusivamente como valor hash irreversible (SHA-256), nunca en texto claro; también se transmiten la dirección IP, el identificador del navegador y el identificador de clic del anuncio. El nombre de empresa que haya introducido y el perfil de Google analizado no se transmiten en ningún caso. Sin consentimiento tampoco se produce esta transmisión del lado del servidor. Base jurídica: consentimiento (art. 6, apdo. 1, letra a del RGPD). Sin consentimiento, el píxel no se carga; puede cambiar su decisión en cualquier momento en «Configuración de cookies», en el pie de página. Más información: facebook.com/privacy/policy."],
        ["Reseñas (Trustpilot)", "Mostramos nuestra valoración actual de Trustpilot y enlazamos a nuestro perfil en Trustpilot (Trustpilot A/S, Dinamarca). Al visitar nuestro sitio no se transmiten datos a Trustpilot; solo al seguir el enlace se aplica la política de privacidad de Trustpilot."],
  ...
  fr: {
    ...
    imp: {
      ...
      rep: "Représentants autorisés", repTxt: "Matthias Lang, Maximilian Hölzl (associés gérants)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Paiements (Stripe, PayPal, Klarna)", "Les paiements sont traités via Stripe (Stripe Payments Europe, Ltd., Irlande). Les données nécessaires au paiement sont transmises à Stripe. Selon le moyen de paiement choisi (p. ex. carte bancaire, PayPal, Klarna, iDEAL), le traitement peut faire intervenir d'autres prestataires de paiement comme PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxembourg) ou Klarna Bank AB (Suède) ; leurs politiques de confidentialité s'appliquent en complément. Base juridique : art. 6, § 1, point b du RGPD. Détails : stripe.com/privacy."],
        ...
        ["Analyse, marketing & suivi d'affiliation (Google Tag Manager, FirstPromoter)", "Ce n'est qu'avec votre consentement, via notre bandeau cookies, que nous chargeons Google Tag Manager (Google Ireland Ltd., Irlande), qui déclenche des balises d'analyse et de marketing (p. ex. mesure des conversions), ainsi que FirstPromoter pour l'attribution des recommandations de partenaires. Des cookies peuvent être déposés et des données (p. ex. adresse IP, données d'appareil et d'utilisation) traitées, avec un éventuel transfert vers des pays tiers (notamment les États-Unis). Base juridique : consentement (art. 6, § 1, point a du RGPD). Sans consentement, ces services ne sont pas chargés ; vous pouvez modifier votre choix à tout moment via « Paramètres des cookies » dans le pied de page."],
        ["Pixel Meta (Facebook, Instagram)", "Ce n'est qu'avec votre consentement, via notre bandeau cookies, que nous chargeons le pixel Meta de Meta Platforms Ireland Ltd. (Irlande). Il nous sert à mesurer la performance de nos publicités sur Facebook et Instagram (p. ex. analyse gratuite envoyée, commande passée) et à constituer des audiences publicitaires. Des cookies peuvent être déposés et des données (p. ex. adresse IP, données d'appareil et d'utilisation, pages consultées, événements déclenchés) traitées et transférées aux États-Unis. Via le pixel du navigateur, nous ne transmettons aucune donnée permettant de vous identifier ; l'« Advanced Matching » est désactivé. En outre, et là encore uniquement avec votre consentement, nous transmettons des événements côté serveur via la Conversions API de Meta, afin qu'une commande puisse être attribuée à la publicité. Votre adresse e-mail et votre numéro de téléphone sont transmis exclusivement sous forme de valeur de hachage irréversible (SHA-256), jamais en clair ; l'adresse IP, l'identifiant du navigateur et l'identifiant de clic de la publicité sont également transmis. Le nom d'entreprise que vous avez saisi et la fiche Google analysée ne sont en aucun cas transmis. Sans consentement, cette transmission côté serveur n'a pas lieu non plus. Base juridique : consentement (art. 6, § 1, point a du RGPD). Sans consentement, le pixel n'est pas chargé ; vous pouvez modifier votre choix à tout moment via « Paramètres des cookies » dans le pied de page. Détails : facebook.com/privacy/policy."],
        ["Avis (Trustpilot)", "Nous affichons notre note Trustpilot actuelle et renvoyons vers notre profil sur Trustpilot (Trustpilot A/S, Danemark). Aucune donnée n'est transmise à Trustpilot lors de la simple visite de notre site ; ce n'est qu'en suivant le lien que la politique de confidentialité de Trustpilot s'applique."],
  ...
  it: {
    ...
    imp: {
      ...
      rep: "Rappresentanti autorizzati", repTxt: "Matthias Lang, Maximilian Hölzl (soci amministratori)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Pagamenti (Stripe, PayPal, Klarna)", "I pagamenti sono gestiti tramite Stripe (Stripe Payments Europe, Ltd., Irlanda). I dati necessari al pagamento vengono trasmessi a Stripe. A seconda del metodo di pagamento scelto (ad es. carta di credito, PayPal, Klarna, iDEAL), l'elaborazione può avvenire tramite altri fornitori di pagamento come PayPal (Europe) S.à r.l. et Cie, S.C.A. (Lussemburgo) o Klarna Bank AB (Svezia); si applicano inoltre le loro informative privacy. Base giuridica: art. 6, par. 1, lett. b del GDPR. Dettagli: stripe.com/privacy."],
        ...
        ["Analisi, marketing & tracciamento affiliati (Google Tag Manager, FirstPromoter)", "Solo con il suo consenso, tramite il nostro avviso cookie, carichiamo Google Tag Manager (Google Ireland Ltd., Irlanda), attraverso cui vengono attivati tag di analisi e marketing (ad es. misurazione delle conversioni), nonché FirstPromoter per l'attribuzione delle segnalazioni dei partner. Possono essere impostati cookie e trattati dati (ad es. indirizzo IP, dati del dispositivo e di utilizzo), con eventuale trasferimento verso Paesi terzi (in particolare USA). Base giuridica: consenso (art. 6, par. 1, lett. a del GDPR). Senza consenso questi servizi non vengono caricati; può modificare la sua decisione in qualsiasi momento tramite «Impostazioni cookie» nel footer."],
        ["Meta Pixel (Facebook, Instagram)", "Solo con il suo consenso, tramite il nostro avviso cookie, carichiamo il Meta Pixel di Meta Platforms Ireland Ltd. (Irlanda). Lo utilizziamo per misurare il rendimento delle nostre inserzioni su Facebook e Instagram (ad es. analisi gratuita inviata, ordine effettuato) e per creare pubblici pubblicitari. Possono essere impostati cookie e trattati dati (ad es. indirizzo IP, dati del dispositivo e di utilizzo, pagine visitate, eventi attivati), con trasferimento negli USA. Tramite il pixel del browser non trasmettiamo alcun dato che la identifichi; l'«Advanced Matching» è disattivato. Inoltre, e anche in questo caso solo con il suo consenso, comunichiamo eventi lato server tramite la Conversions API di Meta, affinché un ordine possa essere attribuito all'inserzione. Il suo indirizzo e-mail e il suo numero di telefono vengono trasmessi esclusivamente come valore hash irreversibile (SHA-256), mai in chiaro; vengono trasmessi anche indirizzo IP, identificativo del browser e identificativo di clic dell'inserzione. Il nome dell'azienda da lei inserito e il profilo Google esaminato non vengono trasmessi in nessun caso. Senza consenso non avviene nemmeno questa trasmissione lato server. Base giuridica: consenso (art. 6, par. 1, lett. a del GDPR). Senza consenso il pixel non viene caricato; può modificare la sua decisione in qualsiasi momento tramite «Impostazioni cookie» nel footer. Dettagli: facebook.com/privacy/policy."],
        ["Recensioni (Trustpilot)", "Mostriamo la nostra valutazione Trustpilot attuale e rimandiamo al nostro profilo su Trustpilot (Trustpilot A/S, Danimarca). Con la semplice visita del nostro sito non vengono trasmessi dati a Trustpilot; solo seguendo il link si applica l'informativa privacy di Trustpilot."],
  ...
  nl: {
    ...
    imp: {
      ...
      rep: "Vertegenwoordigingsbevoegden", repTxt: "Matthias Lang, Maximilian Hölzl (beherende vennoten)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Betalingen (Stripe, PayPal, Klarna)", "Betalingen verlopen via Stripe (Stripe Payments Europe, Ltd., Ierland). De voor de betaling vereiste gegevens worden aan Stripe doorgegeven. Afhankelijk van de gekozen betaalmethode (bijv. creditcard, PayPal, Klarna, iDEAL) kan de afwikkeling via andere betaaldienstverleners verlopen, zoals PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxemburg) of Klarna Bank AB (Zweden); aanvullend gelden hun privacyverklaringen. Rechtsgrondslag: art. 6 lid 1 sub b AVG. Details: stripe.com/privacy."],
        ...
        ["Analyse, marketing & affiliate-tracking (Google Tag Manager, FirstPromoter)", "Alleen met uw toestemming via onze cookiemelding laden wij Google Tag Manager (Google Ireland Ltd., Ierland), waarmee analyse- en marketingtags (bijv. conversiemeting) worden uitgevoerd, en FirstPromoter voor het toewijzen van partnerverwijzingen. Daarbij kunnen cookies worden geplaatst en gegevens (bijv. IP-adres, apparaat- en gebruiksgegevens) worden verwerkt en eventueel doorgegeven aan derde landen (met name de VS). Rechtsgrondslag: toestemming (art. 6 lid 1 sub a AVG). Zonder toestemming worden deze diensten niet geladen; u kunt uw keuze te allen tijde wijzigen via 'Cookie-instellingen' in de footer."],
        ["Meta-pixel (Facebook, Instagram)", "Alleen met uw toestemming via onze cookiemelding laden wij de Meta-pixel van Meta Platforms Ireland Ltd. (Ierland). Daarmee meten wij het resultaat van onze advertenties op Facebook en Instagram (bijv. gratis check verzonden, opdracht geplaatst) en stellen wij advertentiedoelgroepen samen. Daarbij kunnen cookies worden geplaatst en gegevens (bijv. IP-adres, apparaat- en gebruiksgegevens, bekeken pagina's, geactiveerde gebeurtenissen) worden verwerkt en doorgegeven aan de VS. Via de browserpixel versturen wij geen gegevens waarmee u identificeerbaar bent; 'Advanced Matching' is uitgeschakeld. Daarnaast melden wij — eveneens alleen met uw toestemming — gebeurtenissen aan de serverzijde via de Conversions API van Meta, zodat een opdracht aan de advertentie kan worden toegerekend. Uw e-mailadres en telefoonnummer worden uitsluitend als onomkeerbare hashwaarde (SHA-256) doorgegeven, nooit in leesbare vorm; daarnaast worden IP-adres, browserkenmerk en de klik-identificatie van de advertentie doorgegeven. De door u ingevoerde bedrijfsnaam en het gecontroleerde Google-profiel geven wij in geen geval door. Zonder toestemming vindt ook deze doorgifte aan de serverzijde niet plaats. Rechtsgrondslag: toestemming (art. 6 lid 1 sub a AVG). Zonder toestemming wordt de pixel niet geladen; u kunt uw keuze te allen tijde wijzigen via 'Cookie-instellingen' in de footer. Details: facebook.com/privacy/policy."],
        ["Reviews (Trustpilot)", "Wij tonen onze actuele Trustpilot-beoordeling en linken naar ons profiel op Trustpilot (Trustpilot A/S, Denemarken). Bij een gewoon bezoek aan onze website worden geen gegevens aan Trustpilot doorgegeven; pas wanneer u de link volgt, geldt de privacyverklaring van Trustpilot."],
  ...
  pt: {
    ...
    imp: {
      ...
      rep: "Representantes autorizados", repTxt: "Matthias Lang, Maximilian Hölzl (sócios-gerentes)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Pagamentos (Stripe, PayPal, Klarna)", "Os pagamentos são processados através da Stripe (Stripe Payments Europe, Ltd., Irlanda). Os dados necessários ao pagamento são transmitidos à Stripe. Consoante a forma de pagamento escolhida (p. ex., cartão de crédito, PayPal, Klarna, iDEAL), o processamento pode envolver outros prestadores de pagamento, como a PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxemburgo) ou a Klarna Bank AB (Suécia); aplicam-se adicionalmente os respetivos avisos de privacidade. Base jurídica: art. 6.º, n.º 1, alínea b) do RGPD. Detalhes: stripe.com/privacy."],
        ...
        ["Análise, marketing & rastreio de afiliados (Google Tag Manager, FirstPromoter)", "Só com o seu consentimento, através do nosso aviso de cookies, carregamos o Google Tag Manager (Google Ireland Ltd., Irlanda), através do qual são executadas tags de análise e marketing (p. ex., medição de conversões), bem como o FirstPromoter para atribuição de recomendações de parceiros. Podem ser definidos cookies e tratados dados (p. ex., endereço IP, dados do dispositivo e de utilização), com eventual transferência para países terceiros (em particular, EUA). Base jurídica: consentimento (art. 6.º, n.º 1, alínea a) do RGPD). Sem consentimento, estes serviços não são carregados; pode alterar a sua decisão a qualquer momento em «Definições de cookies», no rodapé."],
        ["Pixel da Meta (Facebook, Instagram)", "Só com o seu consentimento, através do nosso aviso de cookies, carregamos o pixel da Meta, da Meta Platforms Ireland Ltd. (Irlanda). Utilizamo-lo para medir o desempenho dos nossos anúncios no Facebook e no Instagram (p. ex., análise gratuita enviada, encomenda efetuada) e para criar públicos publicitários. Podem ser definidos cookies e tratados dados (p. ex., endereço IP, dados do dispositivo e de utilização, páginas visitadas, eventos acionados), com transferência para os EUA. Através do pixel do navegador não transmitimos quaisquer dados que o identifiquem; o «Advanced Matching» está desativado. Além disso, e também apenas com o seu consentimento, comunicamos eventos do lado do servidor através da Conversions API da Meta, para que uma encomenda possa ser atribuída ao anúncio. O seu e-mail e o seu telefone são transmitidos exclusivamente como valor de hash irreversível (SHA-256), nunca em texto legível; são ainda transmitidos o endereço IP, o identificador do navegador e o identificador de clique do anúncio. O nome da empresa que introduziu e o perfil Google analisado não são transmitidos em caso algum. Sem consentimento, também esta transmissão do lado do servidor não ocorre. Base jurídica: consentimento (art. 6.º, n.º 1, alínea a) do RGPD). Sem consentimento, o pixel não é carregado; pode alterar a sua decisão a qualquer momento em «Definições de cookies», no rodapé. Detalhes: facebook.com/privacy/policy."],
        ["Avaliações (Trustpilot)", "Apresentamos a nossa avaliação atual no Trustpilot e remetemos para o nosso perfil no Trustpilot (Trustpilot A/S, Dinamarca). Na simples visita ao nosso site não são transmitidos dados ao Trustpilot; só ao seguir a ligação se aplica a política de privacidade do Trustpilot."],
  ...
  ja: {
    ...
    imp: {
      ...
      rep: "代表者", repTxt: "Matthias Lang, Maximilian Hölzl（業務執行社員）",
    ...
    ds: {
      ...
      secs: [
        ...
        ["決済（Stripe・PayPal・Klarna）", "決済はStripe（Stripe Payments Europe, Ltd.、アイルランド）を通じて処理されます。決済に必要なデータがStripeに送信されます。選択した支払方法（例：クレジットカード、PayPal、Klarna、iDEAL）に応じて、PayPal (Europe) S.à r.l. et Cie, S.C.A.（ルクセンブルク）やKlarna Bank AB（スウェーデン）などの他の決済事業者が処理に関与する場合があり、それぞれのプライバシーポリシーが追加で適用されます。法的根拠：GDPR第6条第1項(b)。詳細：stripe.com/privacy。"],
        ...
        ["分析・マーケティング・アフィリエイト計測（Google Tag Manager、FirstPromoter）", "Cookieバナーでの同意がある場合にのみ、Google Tag Manager（Google Ireland Ltd.、アイルランド）を読み込み、分析・マーケティング用タグ（例：コンバージョン計測）を実行するほか、パートナー紹介の判定のためFirstPromoterを読み込みます。その際、Cookieが設定され、データ（例：IPアドレス、端末・利用データ）が処理され、第三国（特に米国）へ移転される場合があります。法的根拠：同意（GDPR第6条第1項(a)）。同意がない場合、これらのサービスは読み込まれません。フッターの「Cookie設定」からいつでも変更できます。"],
        ["Metaピクセル（Facebook、Instagram）", "Cookieバナーでの同意がある場合にのみ、Meta Platforms Ireland Ltd.（アイルランド）のMetaピクセルを読み込みます。これによりFacebookおよびInstagram上の広告の成果（例：無料チェックの送信、ご依頼の確定）を測定し、広告のオーディエンスを作成します。その際、Cookieが設定され、データ（例：IPアドレス、端末・利用データ、閲覧ページ、発生したイベント）が処理され、米国へ移転される場合があります。ブラウザのピクセルからは、お客様を特定できる情報を送信しません。「詳細マッチング（Advanced Matching）」は無効にしています。加えて、同じくお客様の同意がある場合にのみ、MetaのConversions APIを用いてサーバー側からイベントを送信し、ご依頼を広告に対応づけられるようにします。その際、メールアドレスと電話番号は不可逆のハッシュ値（SHA-256）としてのみ送信し、平文では送信しません。あわせてIPアドレス、ブラウザ識別子、広告のクリック識別子を送信します。入力された会社名および確認したGoogleプロフィールは、いかなる場合も送信しません。同意がない場合、このサーバー側の送信も一切行いません。法的根拠：同意（GDPR第6条第1項(a)）。同意がない場合、ピクセルは読み込まれません。フッターの「Cookie設定」からいつでも変更できます。詳細：facebook.com/privacy/policy。"],
        ["レビュー（Trustpilot）", "当サイトでは現在のTrustpilot評価を表示し、Trustpilot（Trustpilot A/S、デンマーク）のプロフィールへリンクしています。サイトの閲覧だけではTrustpilotへデータは送信されません。リンクをたどった時点で、Trustpilotのプライバシーポリシーが適用されます。"],
  ...
  sv: {
    ...
    imp: {
      ...
      rep: "Behöriga företrädare", repTxt: "Matthias Lang, Maximilian Hölzl (verkställande bolagsmän)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Betalningar (Stripe, PayPal, Klarna)", "Betalningar hanteras via Stripe (Stripe Payments Europe, Ltd., Irland). De uppgifter som krävs för betalningen överförs till Stripe. Beroende på valt betalningssätt (t.ex. kreditkort, PayPal, Klarna, iDEAL) kan hanteringen ske via ytterligare betaltjänstleverantörer som PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxemburg) eller Klarna Bank AB (Sverige); deras integritetspolicyer gäller dessutom. Rättslig grund: art. 6.1 b GDPR. Mer info: stripe.com/privacy."],
        ...
        ["Analys, marknadsföring & affiliate-spårning (Google Tag Manager, FirstPromoter)", "Endast med ditt samtycke via vår cookiebanner läser vi in Google Tag Manager (Google Ireland Ltd., Irland), som kör analys- och marknadsföringstaggar (t.ex. konverteringsmätning), samt FirstPromoter för attribuering av partnerrekommendationer. Cookies kan sättas och uppgifter (t.ex. IP-adress, enhets- och användningsdata) behandlas och eventuellt överföras till tredjeländer (särskilt USA). Rättslig grund: samtycke (art. 6.1 a GDPR). Utan samtycke läses dessa tjänster inte in; du kan när som helst ändra ditt val via ”Cookie-inställningar” i sidfoten."],
        ["Meta-pixel (Facebook, Instagram)", "Endast med ditt samtycke via vår cookiebanner läser vi in Meta-pixeln från Meta Platforms Ireland Ltd. (Irland). Med den mäter vi resultatet av våra annonser på Facebook och Instagram (t.ex. inskickad gratiskontroll, lagd beställning) och bygger annonsmålgrupper. Cookies kan sättas och uppgifter (t.ex. IP-adress, enhets- och användningsdata, besökta sidor, utlösta händelser) behandlas och överföras till USA. Via webbläsarpixeln överför vi inga uppgifter som identifierar dig; ”Advanced Matching” är avaktiverat. Dessutom rapporterar vi – även här endast med ditt samtycke – händelser på serversidan via Metas Conversions API, så att ett uppdrag kan hänföras till annonsen. Din e-postadress och ditt telefonnummer överförs uteslutande som ett oåterkalleligt hashvärde (SHA-256), aldrig i klartext; dessutom överförs IP-adress, webbläsaridentifierare och annonsens klickidentifierare. Företagsnamnet du angett och den kontrollerade Google-profilen överförs aldrig. Utan samtycke sker inte heller denna överföring på serversidan. Rättslig grund: samtycke (art. 6.1 a GDPR). Utan samtycke läses pixeln inte in; du kan när som helst ändra ditt val via ”Cookie-inställningar” i sidfoten. Detaljer: facebook.com/privacy/policy."],
        ["Omdömen (Trustpilot)", "Vi visar vårt aktuella Trustpilot-betyg och länkar till vår profil på Trustpilot (Trustpilot A/S, Danmark). Vid ett vanligt besök på vår webbplats överförs inga uppgifter till Trustpilot; först när du följer länken gäller Trustpilots integritetspolicy."],
  ...
  da: {
    ...
    imp: {
      ...
      contact: "Kontakt", email: "E-mail", phone: "Telefon",
      rep: "Tegningsberettigede", repTxt: "Matthias Lang, Maximilian Hölzl (forretningsførende selskabsdeltagere)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Betalinger (Stripe, PayPal, Klarna)", "Betalinger behandles via Stripe (Stripe Payments Europe, Ltd., Irland). De oplysninger, der er nødvendige for betalingen, overføres til Stripe. Afhængigt af den valgte betalingsmetode (f.eks. kreditkort, PayPal, Klarna, iDEAL) kan behandlingen ske via yderligere betalingstjenesteudbydere som PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxembourg) eller Klarna Bank AB (Sverige); deres privatlivspolitikker gælder derudover. Retsgrundlag: art. 6, stk. 1, litra b GDPR. Detaljer: stripe.com/privacy."],
        ...
        ["Analyse, marketing & affiliate-tracking (Google Tag Manager, FirstPromoter)", "Kun med dit samtykke via vores cookiebanner indlæser vi Google Tag Manager (Google Ireland Ltd., Irland), som afvikler analyse- og marketingtags (f.eks. konverteringsmåling), samt FirstPromoter til henføring af partneranbefalinger. Der kan sættes cookies og behandles data (f.eks. IP-adresse, enheds- og brugsdata), som eventuelt overføres til tredjelande (især USA). Retsgrundlag: samtykke (art. 6, stk. 1, litra a GDPR). Uden samtykke indlæses disse tjenester ikke; du kan til enhver tid ændre dit valg via „Cookie-indstillinger“ i sidefoden."],
        ["Meta-pixel (Facebook, Instagram)", "Kun med dit samtykke via vores cookiebanner indlæser vi Meta-pixlen fra Meta Platforms Ireland Ltd. (Irland). Med den måler vi effekten af vores annoncer på Facebook og Instagram (f.eks. indsendt gratis tjek, afgivet ordre) og danner annoncemålgrupper. Der kan sættes cookies og behandles data (f.eks. IP-adresse, enheds- og brugsdata, besøgte sider, udløste hændelser), som overføres til USA. Via browserpixlen overfører vi ingen oplysninger, der identificerer dig; „Advanced Matching“ er deaktiveret. Derudover indberetter vi – ligeledes kun med dit samtykke – hændelser på serversiden via Metas Conversions API, så en opgave kan henføres til annoncen. Din e-mailadresse og dit telefonnummer overføres udelukkende som en uigenkaldelig hashværdi (SHA-256), aldrig i klartekst; desuden overføres IP-adresse, browseridentifikator og annoncens klikidentifikator. Det firmanavn, du har indtastet, og den kontrollerede Google-profil overfører vi under ingen omstændigheder. Uden samtykke finder heller ikke denne overførsel på serversiden sted. Retsgrundlag: samtykke (art. 6, stk. 1, litra a GDPR). Uden samtykke indlæses pixlen ikke; du kan til enhver tid ændre dit valg via „Cookie-indstillinger“ i sidefoden. Detaljer: facebook.com/privacy/policy."],
        ["Anmeldelser (Trustpilot)", "Vi viser vores aktuelle Trustpilot-bedømmelse og linker til vores profil på Trustpilot (Trustpilot A/S, Danmark). Ved et almindeligt besøg på vores websted overføres ingen data til Trustpilot; først når du følger linket, gælder Trustpilots privatlivspolitik."],
  ...
  no: {
    ...
    imp: {
      ...
      contact: "Kontakt", email: "E-post", phone: "Telefon",
      rep: "Representanter", repTxt: "Matthias Lang, Maximilian Hölzl (forretningsførende deltakere)",
    ...
    ds: {
      ...
      secs: [
        ...
        ["Betalinger (Stripe, PayPal, Klarna)", "Betalinger behandles via Stripe (Stripe Payments Europe, Ltd., Irland). Opplysningene som kreves for betalingen, overføres til Stripe. Avhengig av valgt betalingsmåte (f.eks. kredittkort, PayPal, Klarna, iDEAL) kan behandlingen skje via ytterligere betalingstjenesteleverandører som PayPal (Europe) S.à r.l. et Cie, S.C.A. (Luxembourg) eller Klarna Bank AB (Sverige); deres personvernerklæringer gjelder i tillegg. Rettslig grunnlag: art. 6 nr. 1 bokstav b GDPR. Detaljer: stripe.com/privacy."],
        ...
        ["Analyse, markedsføring & affiliate-sporing (Google Tag Manager, FirstPromoter)", "Kun med ditt samtykke via cookie-banneret vårt laster vi inn Google Tag Manager (Google Ireland Ltd., Irland), som kjører analyse- og markedsføringstagger (f.eks. konverteringsmåling), samt FirstPromoter for å knytte partneranbefalinger. Det kan settes informasjonskapsler og behandles data (f.eks. IP-adresse, enhets- og bruksdata), som eventuelt overføres til tredjeland (særlig USA). Rettslig grunnlag: samtykke (art. 6 nr. 1 bokstav a GDPR). Uten samtykke lastes ikke disse tjenestene; du kan når som helst endre valget ditt via «Cookie-innstillinger» i bunnteksten."],
        ["Meta-piksel (Facebook, Instagram)", "Kun med ditt samtykke via cookie-banneret vårt laster vi inn Meta-pikselen fra Meta Platforms Ireland Ltd. (Irland). Med den måler vi effekten av annonsene våre på Facebook og Instagram (f.eks. innsendt gratis sjekk, inngitt bestilling) og bygger annonsemålgrupper. Det kan settes informasjonskapsler og behandles data (f.eks. IP-adresse, enhets- og bruksdata, besøkte sider, utløste hendelser), som overføres til USA. Via nettleserpikselen overfører vi ingen opplysninger som identifiserer deg; «Advanced Matching» er deaktivert. I tillegg rapporterer vi – også her kun med ditt samtykke – hendelser på serversiden via Metas Conversions API, slik at et oppdrag kan tilskrives annonsen. E-postadressen og telefonnummeret ditt overføres utelukkende som en uopprettelig hashverdi (SHA-256), aldri i klartekst; i tillegg overføres IP-adresse, nettleseridentifikator og annonsens klikkidentifikator. Firmanavnet du har oppgitt og den kontrollerte Google-profilen overfører vi under ingen omstendigheter. Uten samtykke skjer heller ikke denne overføringen på serversiden. Rettslig grunnlag: samtykke (art. 6 nr. 1 bokstav a GDPR). Uten samtykke lastes ikke pikselen; du kan når som helst endre valget ditt via «Cookie-innstillinger» i bunnteksten. Detaljer: facebook.com/privacy/policy."],
        ["Omtaler (Trustpilot)", "Vi viser vår gjeldende Trustpilot-vurdering og lenker til profilen vår på Trustpilot (Trustpilot A/S, Danmark). Ved et vanlig besøk på nettstedet vårt overføres ingen data til Trustpilot; først når du følger lenken, gjelder Trustpilots personvernerklæring."],
