  ...
  de: {
    ...
    ds: {
      ...
      secs: [
        ...
        ["Meta-Pixel (Facebook, Instagram)", "Nur mit Ihrer Einwilligung über unseren Cookie-Hinweis laden wir das Meta-Pixel von Meta Platforms Ireland Ltd. (Irland). Damit messen wir den Erfolg unserer Werbeanzeigen auf Facebook und Instagram (z. B. abgeschickter Gratis-Check, erteilter Auftrag) und bilden Zielgruppen für Werbung. Dabei können Cookies gesetzt und Daten (z. B. IP-Adresse, Geräte- und Nutzungsdaten, aufgerufene Seiten, ausgelöste Ereignisse) verarbeitet und in die USA übermittelt werden. Wir übermitteln dabei ausdrücklich KEINE Angaben, die Sie identifizieren – insbesondere nicht den von Ihnen eingegebenen Firmennamen, Ihre E-Mail-Adresse, Telefonnummer oder Adresse, auch nicht in gehashter Form; „Advanced Matching“ ist deaktiviert. Rechtsgrundlage: Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Ohne Einwilligung wird das Pixel nicht geladen; Sie können Ihre Entscheidung jederzeit über „Cookie-Einstellungen“ im Footer ändern. Details: facebook.com/privacy/policy."],
  ...
  fr: {
    ...
    ds: {
      ...
      secs: [
        ...
        ["Pixel Meta (Facebook, Instagram)", "Ce n'est qu'avec votre consentement, via notre bandeau cookies, que nous chargeons le pixel Meta de Meta Platforms Ireland Ltd. (Irlande). Il nous sert à mesurer la performance de nos publicités sur Facebook et Instagram (p. ex. analyse gratuite envoyée, commande passée) et à constituer des audiences publicitaires. Des cookies peuvent être déposés et des données (p. ex. adresse IP, données d'appareil et d'utilisation, pages consultées, événements déclenchés) traitées et transférées aux États-Unis. Nous ne transmettons expressément AUCUNE donnée permettant de vous identifier, en particulier ni le nom d'entreprise que vous avez saisi, ni votre adresse e-mail, votre numéro de téléphone ou votre adresse postale, pas même sous forme hachée ; l'« Advanced Matching » est désactivé. Base juridique : consentement (art. 6, § 1, point a du RGPD). Sans consentement, le pixel n'est pas chargé ; vous pouvez modifier votre choix à tout moment via « Paramètres des cookies » dans le pied de page. Détails : facebook.com/privacy/policy."],
  ...
  nl: {
    ...
    ds: {
      ...
      secs: [
        ...
        ["Meta-pixel (Facebook, Instagram)", "Alleen met uw toestemming via onze cookiemelding laden wij de Meta-pixel van Meta Platforms Ireland Ltd. (Ierland). Daarmee meten wij het resultaat van onze advertenties op Facebook en Instagram (bijv. gratis check verzonden, opdracht geplaatst) en stellen wij advertentiedoelgroepen samen. Daarbij kunnen cookies worden geplaatst en gegevens (bijv. IP-adres, apparaat- en gebruiksgegevens, bekeken pagina's, geactiveerde gebeurtenissen) worden verwerkt en doorgegeven aan de VS. Wij versturen uitdrukkelijk GEEN gegevens waarmee u identificeerbaar bent — in het bijzonder niet de door u ingevoerde bedrijfsnaam, uw e-mailadres, telefoonnummer of adres, ook niet in gehashte vorm; 'Advanced Matching' is uitgeschakeld. Rechtsgrondslag: toestemming (art. 6 lid 1 sub a AVG). Zonder toestemming wordt de pixel niet geladen; u kunt uw keuze te allen tijde wijzigen via 'Cookie-instellingen' in de footer. Details: facebook.com/privacy/policy."],
  ...
  pt: {
    ...
    ds: {
      ...
      secs: [
        ...
        ["Pixel da Meta (Facebook, Instagram)", "Só com o seu consentimento, através do nosso aviso de cookies, carregamos o pixel da Meta, da Meta Platforms Ireland Ltd. (Irlanda). Utilizamo-lo para medir o desempenho dos nossos anúncios no Facebook e no Instagram (p. ex., análise gratuita enviada, encomenda efetuada) e para criar públicos publicitários. Podem ser definidos cookies e tratados dados (p. ex., endereço IP, dados do dispositivo e de utilização, páginas visitadas, eventos acionados), com transferência para os EUA. Não transmitimos expressamente NENHUM dado que o identifique, em particular nem o nome da empresa que introduziu, nem o seu e-mail, telefone ou morada, tampouco em forma cifrada (hash); o «Advanced Matching» está desativado. Base jurídica: consentimento (art. 6.º, n.º 1, alínea a) do RGPD). Sem consentimento, o pixel não é carregado; pode alterar a sua decisão a qualquer momento em «Definições de cookies», no rodapé. Detalhes: facebook.com/privacy/policy."],
  ...
  ja: {
    ...
    ds: {
      ...
      secs: [
        ...
        ["Metaピクセル（Facebook、Instagram）", "Cookieバナーでの同意がある場合にのみ、Meta Platforms Ireland Ltd.（アイルランド）のMetaピクセルを読み込みます。これによりFacebookおよびInstagram上の広告の成果（例：無料チェックの送信、ご依頼の確定）を測定し、広告のオーディエンスを作成します。その際、Cookieが設定され、データ（例：IPアドレス、端末・利用データ、閲覧ページ、発生したイベント）が処理され、米国へ移転される場合があります。お客様を特定できる情報は一切送信しません。特に、入力された会社名、メールアドレス、電話番号、住所は送信せず、ハッシュ化した形でも送信しません。「詳細マッチング（Advanced Matching）」は無効にしています。法的根拠：同意（GDPR第6条第1項(a)）。同意がない場合、ピクセルは読み込まれません。フッターの「Cookie設定」からいつでも変更できます。詳細：facebook.com/privacy/policy。"],
  ...
  sv: {
    ...
    ds: {
      ...
      secs: [
        ...
        ["Meta-pixel (Facebook, Instagram)", "Endast med ditt samtycke via vår cookiebanner läser vi in Meta-pixeln från Meta Platforms Ireland Ltd. (Irland). Med den mäter vi resultatet av våra annonser på Facebook och Instagram (t.ex. inskickad gratiskontroll, lagd beställning) och bygger annonsmålgrupper. Cookies kan sättas och uppgifter (t.ex. IP-adress, enhets- och användningsdata, besökta sidor, utlösta händelser) behandlas och överföras till USA. Vi överför uttryckligen INGA uppgifter som identifierar dig – i synnerhet inte företagsnamnet du angett, din e-postadress, ditt telefonnummer eller din adress, inte heller i hashad form; ”Advanced Matching” är avaktiverat. Rättslig grund: samtycke (art. 6.1 a GDPR). Utan samtycke läses pixeln inte in; du kan när som helst ändra ditt val via ”Cookie-inställningar” i sidfoten. Detaljer: facebook.com/privacy/policy."],
  ...
  no: {
    ...
    ds: {
      ...
      secs: [
        ...
        ["Meta-piksel (Facebook, Instagram)", "Kun med ditt samtykke via cookie-banneret vårt laster vi inn Meta-pikselen fra Meta Platforms Ireland Ltd. (Irland). Med den måler vi effekten av annonsene våre på Facebook og Instagram (f.eks. innsendt gratis sjekk, inngitt bestilling) og bygger annonsemålgrupper. Det kan settes informasjonskapsler og behandles data (f.eks. IP-adresse, enhets- og bruksdata, besøkte sider, utløste hendelser), som overføres til USA. Vi overfører uttrykkelig INGEN opplysninger som identifiserer deg – særlig ikke firmanavnet du har oppgitt, e-postadressen, telefonnummeret eller adressen din, heller ikke i hashet form; «Advanced Matching» er deaktivert. Rettslig grunnlag: samtykke (art. 6 nr. 1 bokstav a GDPR). Uten samtykke lastes ikke pikselen; du kan når som helst endre valget ditt via «Cookie-innstillinger» i bunnteksten. Detaljer: facebook.com/privacy/policy."],
