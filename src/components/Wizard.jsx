...
const CONV = {
  de: {
    ...
    paypalNote: "Können Sie mit PayPal zahlen? Dann erhalten Sie 10 % Rabatt auf Ihre Bestellung.",
  ...
  en: {
    ...
    paypalNote: "Can you pay with PayPal? Then you get 10% off your order.",
  ...
  es: {
    ...
    tierMonthlyLabel: "Mensual", tierMonitorLabel: "Monitorización automática", tierLifetimeLabel: "De por vida", protMonitorName: "Monitorización automática", protMonthlyName: "Protección mensual", protLifetimeName: "Protección de por vida",
    ...
    paypalNote: "¿Puede pagar con PayPal? Reciba un 10 % de descuento en su pedido.",
  ...
  fr: {
    ...
    tierMonthlyLabel: "Mensuel", tierMonitorLabel: "Surveillance automatique", tierLifetimeLabel: "À vie", protMonitorName: "Surveillance automatique", protMonthlyName: "Protection mensuelle", protLifetimeName: "Protection à vie",
    ...
    paypalNote: "Pouvez-vous payer avec PayPal ? Bénéficiez de 10 % de réduction sur votre commande.",
  ...
  it: {
    ...
    tierMonthlyLabel: "Mensile", tierMonitorLabel: "Monitoraggio automatico", tierLifetimeLabel: "A vita", protMonitorName: "Monitoraggio automatico", protMonthlyName: "Protezione mensile", protLifetimeName: "Protezione a vita",
    ...
    paypalNote: "Può pagare con PayPal? Riceve il 10% di sconto sul suo ordine.",
  ...
  nl: {
    ...
    tierMonthlyLabel: "Maandelijks", tierMonitorLabel: "Automatische monitoring", tierLifetimeLabel: "Levenslang", protMonitorName: "Automatische monitoring", protMonthlyName: "Maandelijkse bescherming", protLifetimeName: "Levenslange bescherming",
    ...
    paypalNote: "Kunt u met PayPal betalen? Dan krijgt u 10% korting op uw bestelling.",
  ...
  pt: {
    ...
    tierMonthlyLabel: "Mensal", tierMonitorLabel: "Monitorização automática", tierLifetimeLabel: "Vitalícia", protMonitorName: "Monitorização automática", protMonthlyName: "Proteção mensal", protLifetimeName: "Proteção vitalícia",
    ...
    paypalNote: "Pode pagar com PayPal? Receba 10% de desconto na sua encomenda.",
  ...
  ja: {
    ...
    tierMonthlyLabel: "月額", tierMonitorLabel: "自動モニタリング", tierLifetimeLabel: "永久", protMonitorName: "自動モニタリング", protMonthlyName: "月額保護", protLifetimeName: "永久保護",
    ...
    totalAfter: "成功後の合計",
    paypalNote: "PayPalでお支払いいただけますか？ ご注文が10%割引になります。",
  ...
  sv: {
    ...
    tierMonthlyLabel: "Månadsvis", tierMonitorLabel: "Automatisk övervakning", tierLifetimeLabel: "Livstid", protMonitorName: "Automatisk övervakning", protMonthlyName: "Månadsskydd", protLifetimeName: "Livstidsskydd",
    ...
    paypalNote: "Kan du betala med PayPal? Då får du 10 % rabatt på din beställning.",
  ...
  da: {
    ...
    tierMonthlyLabel: "Månedligt", tierMonitorLabel: "Automatisk overvågning", tierLifetimeLabel: "Livsvarig", protMonitorName: "Automatisk overvågning", protMonthlyName: "Månedlig beskyttelse", protLifetimeName: "Livsvarig beskyttelse",
    ...
    paypalNote: "Kan du betale med PayPal? Så får du 10 % rabat på din ordre.",
  ...
  no: {
    ...
    tierMonthlyLabel: "Månedlig", tierMonitorLabel: "Automatisk overvåking", tierLifetimeLabel: "Livsvarig", protMonitorName: "Automatisk overvåking", protMonthlyName: "Månedlig beskyttelse", protLifetimeName: "Livsvarig beskyttelse",
    ...
    paypalNote: "Kan du betale med PayPal? Da får du 10 % rabatt på bestillingen din.",
