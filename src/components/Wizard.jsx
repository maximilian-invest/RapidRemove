...
const CONV = {
  ...
  es: {
    ...
    protSub: "Terceros — a menudo competidores — pueden volver a publicar tu perfil en Google en cualquier momento. Con protección lo eliminamos de nuevo gratis, de forma permanente.",
  ...
  fr: {
    ...
    protSub: "Des tiers — souvent des concurrents — peuvent réinscrire votre fiche sur Google à tout moment. Avec la protection, nous la supprimons à nouveau gratuitement, durablement.",
  ...
  it: {
    ...
    protSub: "Terzi — spesso concorrenti — possono ripubblicare il tuo profilo su Google in qualsiasi momento. Con la protezione lo rimuoviamo di nuovo gratis, in modo permanente.",
  ...
  nl: {
    ...
    protSub: "Derden — vaak concurrenten — kunnen uw profiel op elk moment opnieuw op Google plaatsen. Met bescherming verwijderen we het opnieuw gratis, permanent.",
  ...
  pt: {
    ...
    protSub: "Terceiros — muitas vezes concorrentes — podem voltar a publicar o seu perfil no Google a qualquer momento. Com proteção, removemo-lo de novo gratuitamente, de forma permanente.",
  ...
  ja: {
    ...
    protH: "再登録からの保護",
    protSub: "第三者(多くは競合)はいつでもあなたのプロフィールをGoogleに再登録できます。保護があれば、何度でも無料で永続的に削除します。",
  ...
  sv: {
    ...
    protSub: "Tredje part — ofta konkurrenter — kan när som helst lägga upp din profil igen på Google. Med skydd tar vi bort den gratis igen, permanent.",
  ...
  da: {
    ...
    protSub: "Tredjeparter — ofte konkurrenter — kan til enhver tid oprette din profil igen på Google. Med beskyttelse fjerner vi den igen gratis, permanent.",
  ...
  no: {
    ...
    protSub: "Tredjeparter — ofte konkurrenter — kan når som helst legge ut profilen din på Google igjen. Med beskyttelse fjerner vi den gratis igjen, permanent.",
