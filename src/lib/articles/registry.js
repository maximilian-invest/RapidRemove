...
export const CLUSTER_CARDS = [
  ...
  { slug: "google-maps-eintrag-loeschen", cat: "Google-Policy", thm: "thm-ink", icon: "mapPin", title: "Google Maps Eintrag löschen", excerpt: "Eigene, fremde, falsche & doppelte Einträge entfernen – und warum der Eintrag oft bleibt.", author: "Matthias Lang", read: 11, date: "Juni 2026" },
