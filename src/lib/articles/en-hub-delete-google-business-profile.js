...
const article = {
  meta: {
    ...
    h1: "How to delete your Google Business Profile (for real)",
    description:
      "Google won't let you simply delete your Business Profile. This guide explains why “permanently closed” isn't deletion – and how to remove it, and all its reviews, for good.",
  ...
  iconKey: "trash",
  readingMin: 9,
  dek: "“Permanently closed” is not the same as deleted: your profile, name, address and every review stay visible on Google. This guide shows what actually works to remove a Google Business Profile completely – and why there is no simple delete button for business owners.",
  blocks: [
