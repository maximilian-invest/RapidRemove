...
const article = {
  ...
  blocks: [
    ...
    { t: "p", text: "Cela devient particulièrement amer avec les **avis falsifiés ou injustifiés** – de concurrents, d'ex-salariés mécontents ou de personnes qui n'ont jamais été clientes. Rien qu'en Allemagne, le préjudice économique des faux avis négatifs est estimé à environ 3,8 milliards d'euros par an." },
