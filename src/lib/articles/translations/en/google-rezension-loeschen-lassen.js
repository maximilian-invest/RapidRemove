/* EN — google-rezension-loeschen-lassen */
const article = {
  category: "Guide",
  meta: {
    slug: "how-to-delete-a-google-review",
    title: "How to Delete a Google Review: Form, Costs & Guide (2026)",
    h1: "How to Delete a Google Review: Form, Costs & Guide",
    description: "Delete a Google review – with or without a form, free or via an agency? How to remove your own and others' reviews, and how to see which review was deleted.",
    keywords: ["delete a google review", "google review removal form", "google review removal cost", "delete own google review", "delete google review free", "remove a google review"],
    author: "Matthias Lang",
    authorRole: "Google expert",
    date: "2026-06-04",
  },
  dek: "Whether it's your own review you want to take back, or someone else's that's hurting your business: in this guide you'll learn **how to delete a Google review** – free via the report form, as a business via the official management tools, and, if needed, permanently via an agency. Plus: how to tell whether a review was really removed.",
  blocks: [
    { t: "note", title: "Note", text: "This article is a practical guide and not legal advice." },

    { t: "h2", id: "eigene", text: "Delete your own Google review", toc: "Delete your own" },
    ...
    { t: "h2", id: "formular", text: "Have a third-party review removed: the form", toc: "The form" },
    ...
    { t: "p", text: "Important: a removal only happens if Google finds a **guideline violation**. Pure expressions of opinion about real experiences are usually not removed." },
    ...
    { t: "ul", items: [
      ...
      "**Guarantee:** if the profile reappears via third parties, it's removed for free",
