...
const article = {
  ...
  blocks: [
    ...
    { t: "p", text: "Many business owners are surprised to find a Maps listing they never created. That's completely normal: listings are generated by other users, by Google's automated data collection from across the web, or by imports from official registries. You can read the full breakdown in our guide [Delete a Google Business Profile](/en/magazine/delete-google-business-profile/). The key takeaway here: because the listing rarely originated with you, your account settings give you only limited control over it." },
