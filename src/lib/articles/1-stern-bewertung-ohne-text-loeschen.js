/* Article: 1-Stern-Bewertung ohne Text löschen lassen */
const article = {
  meta: {
  ...
  blocks: [
    ...
    { t: "ul", items: [
      "Das **Landgericht Lübeck** entschied bereits 2018 (Beschl. v. 13.06.2018 – Az. [9 O 59/17](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=9+O+59/17)), dass eine Google-Bewertung mit einem Stern ohne Text gelöscht werden muss.",
      "Auch der **Bundesgerichtshof** stellte klar (Urt. v. 01.03.2016 – Az. [VI ZR 34/15](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=VI+ZR+34/15)), dass Bewertungsportale beanstandete Bewertungen auf einen **tatsächlichen Geschäftskontakt** prüfen müssen – fehlt dieser, kann die Bewertung unzulässig sein.",
    ] },
  ...
  faq: [
    { q: "Kann ich eine 1-Stern-Bewertung ohne Text löschen lassen?", a: "In vielen Fällen ja. Da kein Bezug zu einer echten Erfahrung erkennbar ist, fehlt der Bewertung oft die rechtliche Grundlage – das LG Lübeck (Az. [9 O 59/17](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=9+O+59/17)) und der BGH (Az. [VI ZR 34/15](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=VI+ZR+34/15)) haben entsprechende Prüf- und Löschansprüche bestätigt." },
    ...
    { q: "Löscht RapidRemove die einzelne 1-Stern-Bewertung?", a: "Nein. RapidRemove entfernt das gesamte Unternehmensprofil; alle Bewertungen verschwinden dabei mit. Möchten Sie nur die eine Bewertung loswerden und das Profil behalten, sind das Melden oder ein Anwalt zuständig." },
