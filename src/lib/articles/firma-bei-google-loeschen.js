...
const article = {
  ...
  blocks: [
    ...
    { t: "p", text: "Mit „Firma bei Google löschen“ ist fast immer das **Google-Unternehmensprofil** gemeint – der Eintrag mit Name, Adresse, Öffnungszeiten, Fotos und **Bewertungen**, der in der Google-Suche und in Google Maps erscheint. Genau dieser öffentliche Eintrag soll weg. Die ausführliche Schritt-für-Schritt-Anleitung dazu finden Sie in unserem Leitfaden [Google-Unternehmensprofil löschen](https://rapid-remove.com/magazin/google-unternehmensprofil-loeschen/)." },
    ...
    { t: "p", text: "Geht es Ihnen nur um eine einzelne ungerechtfertigte Bewertung, ist das **Melden** oder der Anwaltsweg richtig – mehr dazu unter [Google Bewertung löschen lassen](https://rapid-remove.com/google-bewertung-loeschen-lassen/). Ist der Eintrag insgesamt beschädigt und Sie wollen einen echten Neuanfang, ist die vollständige Entfernung der direktere Weg." },
