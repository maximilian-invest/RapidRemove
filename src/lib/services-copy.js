...
export const ORM = {
  de: {
    ...
    cta: "Kostenloses Reputations-Audit",
    ...
    problemSub: "Presseartikel, Foren, fremde Websites — vieles ist durch die Pressefreiheit oder fremde Rechte geschützt. Löschen ist dann nicht möglich. Aber: Was auf Seite 2+ rutscht, sieht praktisch niemand. 95 % aller Klicks bleiben auf Seite 1.",
  ...
  en: {
    ...
    problemSub: "Press articles, forums, third-party sites — much is protected by press freedom or others' rights. Deletion isn't possible then. But: whatever drops to page 2+ is seen by almost no one. 95% of all clicks stay on page 1.",
