  ...
  de: {
    ...
    wizard: {
      ...
      s2: {
        ...
        multiSub: "Wählen Sie das richtige Profil aus.",
      ...
      s4: {
        ...
        planMonthly: "Monatlich", planMonitor: "+ Tägliche Überwachung", planLifetime: "Lebenslang",
  ...
  en: {
    ...
    wizard: {
      ...
      s2: {
        ...
        multiSub: "Pick the right profile.",
      ...
      s4: {
        ...
        planMonthly: "Monthly", planMonitor: "+ Daily monitoring", planLifetime: "Lifetime",
        per: "/ mo.", once: "once",
