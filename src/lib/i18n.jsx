...
const I18N = {
  ...
  de: {
    ...
    social: {
      ...
      stats: [
        ...
        { v: 260, suf: "+", l: "5★-Bewertungen" },
      ],
      tpScore: "5,0 von 5", tpCount: "Basierend auf 260+ Bewertungen", tpLink: "Auf Trustpilot ansehen",
      testimonials: [
    ...
    cta: {
      ...
      sub: "Geben Sie Ihren Firmennamen ein und sehen Sie in wenigen Sekunden, ob sich Ihr Profil entfernen lässt – kostenlos und unverbindlich.",
      placeholder: "Name und Ort des Unternehmens",
    ...
    blog: {
      ...
      articles: [
        ...
        { cat: "Fallstudien", thm: "thm-plum", icon: "refresh", title: "Vom 1-Stern-Albtraum zum Neustart: ein Autohaus in 24 Stunden", excerpt: "Wie wir ein durch Fake-Bewertungen ruiniertes Profil entfernt und sauber neu aufgebaut haben – mit Zahlen aus dem echten Fall.", author: "Maximilian Hölzl", read: 7, date: "April 2026" },
  ...
  en: {
    ...
    social: {
      ...
      tpScore: "5.0 out of 5", tpCount: "Based on 260+ reviews", tpLink: "View on Trustpilot",
      testimonials: [
    ...
    cta: {
      ...
      placeholder: "Your business name + city",
      button: "Check for free",
      trust: ["Pay only after success", "GDPR / EU"],
    },
    footer: {
    ...
    blog: {
      ...
      articles: [
        { cat: "Reputation", thm: "thm-orange", icon: "star", title: "How a single fake review can cost a business millions", excerpt: "A 1-star review can cut click-through by up to 30%. We do the math on what it really costs – and when removal pays for itself.", author: "Maximilian Hölzl", read: 8, date: "May 2026" },
        ...
        { cat: "Case studies", thm: "thm-plum", icon: "refresh", title: "From 1-star nightmare to a fresh start: a dealership in 24 hours", excerpt: "How we removed a profile ruined by fake reviews and rebuilt it cleanly – with numbers from the real case.", author: "Maximilian Hölzl", read: 7, date: "April 2026" },
    ...
    wizard: {
      ...
      s5: {
        ...
        f: { name: "Your name", email: "Email", phone: "Phone (optional)", company: "Profile to delete", profileUrl: "Google profile link (if any)" },
